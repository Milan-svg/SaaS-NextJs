        ...
        <Card className="mb-12 border-none bg-gradient-to-r from-primary/20 to-secondary/20">
          ...
          <CardContent>
            <p className="text-center text-xl text-muted-foreground mb-8">
              Revolutionize your productivity with EpicTodo - The ultimate
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 gap-6">
              <blockquote className="italic text-lg text-muted-foreground">
                &ldquo;EpicTodo has transformed the way our team manages
              ...
              <blockquote className="italic text-lg text-muted-foreground">
                &ldquo;I&apos;ve tried many task management apps, but EpicTodo
      ...
      <footer className="bg-muted py-8">
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
          ...
          <p className="text-center text-sm text-muted-foreground">
            &copy; 2024 EpicTodo. All rights reserved. |{" "}
